      ...
      <table className="min-w-full">
        <thead>
          <tr>
            ...
            <th className="px-6 py-3 pl-10 md:pl-40 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 tracking-wider whitespace-nowrap">Amount</th>
            <th className="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 tracking-wider whitespace-nowrap">Date</th>
            <th className="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 tracking-wider whitespace-nowrap">Status</th>
            <th className="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 tracking-wider">Users on plan</th>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {testData.map((item) => (
            <tr key={item.id}>
              ...
              <td className="px-3 md:px-0 py-3 text-[14px] font-[400px] text-gray-500 whitespace-nowrap">{item.name}</td>
              <td className="px-3 md:px-0 py-3 text-[14px] font-[400px] text-gray-500 whitespace-nowrap">{item.age}</td>
